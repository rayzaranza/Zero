...
namespace Zero
{
    ...
    void UILayer::OnEvent(Event& event)
    {
        ...
        dispatcher.Dispatch<MouseButtonPressedEvent>(ZERO_BIND_FUNCTION(UILayer::OnMouseButtonPressedEvent));
        dispatcher.Dispatch<MouseButtonReleasedEvent>(ZERO_BIND_FUNCTION(UILayer::OnMouseButtonReleasedEvent));
        dispatcher.Dispatch<MouseMovedEvent>(ZERO_BIND_FUNCTION(UILayer::OnMouseMovedEvent));
        dispatcher.Dispatch<KeyPressedEvent>(ZERO_BIND_FUNCTION(UILayer::OnKeyPressedEvent));
        dispatcher.Dispatch<KeyReleasedEvent>(ZERO_BIND_FUNCTION(UILayer::OnKeyReleasedEvent));
        dispatcher.Dispatch<KeyTypedEvent>(ZERO_BIND_FUNCTION(UILayer::OnKeyTypedEvent));
        dispatcher.Dispatch<WindowResizedEvent>(ZERO_BIND_FUNCTION(UILayer::OnWindowResizedEvent));
    }
    ...
    static void setKeyModifiers(ImGuiIO& io, GLFWwindow* window)
    {
    ...
    bool UILayer::OnKeyTypedEvent(KeyTypedEvent& event)
    {
        ImGuiIO& io { ImGui::GetIO() };
    ...
    bool UILayer::OnWindowResizedEvent(WindowResizedEvent& event)
    {
        const unsigned int width { event.GetWidth() };
        const unsigned int height { event.GetWidth() };
        ImGuiIO& io { ImGui::GetIO() };
