...
namespace Zero
{
    ...
    void OpenGLShader::Compile(const Map<uint32_t, std::string>& shaderSources)
    {
        ZR_PROFILE_FUNCTION();
    ...
    Map<uint32_t, std::string> OpenGLShader::PreProcess(const std::string& source)
    {
        ZR_PROFILE_FUNCTION();
    ...
    void OpenGLShader::SetColor(const std::string& name, const glm::vec4& color) const
    {
        ZR_PROFILE_FUNCTION();
    ...
    void OpenGLShader::SetVector4(const std::string& name, const glm::vec4& vector) const
    {
        ZR_PROFILE_FUNCTION();
    ...
    void OpenGLShader::SetVector3(const std::string& name, const glm::vec3& vector) const
    {
        ZR_PROFILE_FUNCTION();
    ...
    void OpenGLShader::SetVector2(const std::string& name, const glm::vec2& vector) const
    {
        ZR_PROFILE_FUNCTION();
    ...
    void OpenGLShader::SetInt(const std::string& name, const int32_t value) const
    {
        ZR_PROFILE_FUNCTION();
    ...
    void OpenGLShader::SetUnsignedInt(const std::string& name, const uint32_t value) const
    {
        ZR_PROFILE_FUNCTION();
    ...
    void OpenGLShader::SetIntArray(const std::string& name, const int32_t* values, const uint32_t count) const
    {
        ZR_PROFILE_FUNCTION();
    ...
    void OpenGLShader::SetUnsignedIntArray(const std::string& name, const uint32_t* values, const uint32_t count) const
    {
        ZR_PROFILE_FUNCTION();
    ...
    uint32_t OpenGLShader::StringToShaderType(const std::string& type)
    {
        if (type == "vertex")
    ...
    bool OpenGLShader::CheckShaderErrors(uint32_t shader)
    {
        int32_t isCompiled{};
    ...
    bool OpenGLShader::CheckProgramErrors(uint32_t program, const FixedArray<uint32_t, MAX_SHADERS_SUPPORTED>& shaderIds)
    {
        int32_t isLinked{ 0 };
